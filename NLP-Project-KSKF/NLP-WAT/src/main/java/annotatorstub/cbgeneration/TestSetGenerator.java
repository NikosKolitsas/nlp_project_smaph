...
public class TestSetGenerator {
    ...
    public static void main(String args[]) {
        TestSetGenerator gen = new TestSetGenerator();
        gen.generate();
    }
    ...
    public void generate() {
        ...
        try {
            WATRelatednessComputer.setCache("rel-caches/wat/relatedness_test.cache");
        } catch (Exception e) {
        ...
        System.out.println("Writing test samples...");
        ...
        try
        {
            FileWriter fstream = new FileWriter("python/data/wat/test.csv", false); // true tells to append data.
            ...
            for (TestSample sample : testSet) {
            	if (i % 50 == 0) {
            		System.out.println("Writing test sample " + i + " / " + len);
				}
