...
public class DevelSetGenerator {
    ...
    public void generate() {
        ...
        try {
            WATRelatednessComputer.setCache("rel-caches/wat/relatedness_devel.cache");
        } catch (Exception e) {
        ...
        try
        {
            FileWriter fstream = new FileWriter("python/data/wat/devel.csv", false); // true tells to append data.
