...
public class OutOfDomainBenchmarkMain {
    public static void main(String[] args) throws Exception {
        ...
        A2WDataset ds = new YahooWebscopeL24Dataset("datasets/out-domain-dataset-new.xml");

        // Select annotator
        FakeAnnotator ann = new SMAPHKSKFAnnotator(0.2, "python/data/oo_prediction.csv", ds);
        //FakeAnnotator ann = new FakeAnnotator(); // new SMAPHKSKFAnnotator(0.2, "python/data/oo_prediction.csv"); //SMAPHKSKFAnnotator SMAPHKSKFAnnotator(0.2, "python/data/oo_prediction.csv"); // TODO: THRESHOLD VALUE
