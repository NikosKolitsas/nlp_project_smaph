...
public class TrainingSetGenerator {
    ...
    public void generate() {
        String trainSetChosen = "a"; // b

        try {
            WATRelatednessComputer.setCache("rel-caches/tagme/relatedness_" + trainSetChosen + ".cache");
        } catch (Exception e) {
        ...
        try
        {
            FileWriter fstream = new FileWriter("python/data/training_" + trainSetChosen + ".csv", false); // true tells to append data.
