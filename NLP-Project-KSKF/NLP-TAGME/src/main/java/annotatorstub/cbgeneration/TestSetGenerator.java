...
public class TestSetGenerator {
    ...
    public void generate() {
        ...
        try {
            WATRelatednessComputer.setCache("rel-caches/tagme/relatedness_test.cache");
        } catch (Exception e) {
        ...
        try
        {
            FileWriter fstream = new FileWriter("python/data/test.csv", false); // true tells to append data.
